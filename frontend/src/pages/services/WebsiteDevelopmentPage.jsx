...
import { ArrowLeft, Globe, Code, Zap, CheckCircle2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1547658719-da2b51169166?w=1920&q=80')] bg-cover bg-center opacity-10"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          <p className="text-2xl text-gray-300 max-w-4xl animate-fade-in-delayed">
            Robust static website development focused on speed, security, and seamless user experience for real estate brands.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div className="space-y-6">
              <div className="bg-white rounded-3xl p-10 shadow-xl border border-gray-100 card-3d">
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-4">
                  Transform your real estate vision into a powerful online presence with our professional website development services. We create fast, secure, and user-friendly websites tailored to your business needs.
                </p>
                <p className="text-gray-600 text-lg leading-relaxed">
                  From custom designs to robust functionality, we build websites that capture your brand identity and engage clients effectively.
                </p>
              </div>
            </div>
            ...
            <div className="relative h-96 bg-gradient-to-br from-cyan-500 via-blue-500 to-purple-500 rounded-3xl overflow-hidden shadow-2xl card-3d">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Globe className="w-32 h-32 text-white/30 tilt-animation" />
              </div>
            </div>
          </div>
