...
import { ArrowLeft, Target, MousePointerClick, TrendingUp, CheckCircle2 } from 'lucide-react';
import { Button } from '../../components/ui/button';
import Navbar from '../../components/Navbar';
import Footer from '../../components/Footer';

const SEMServicesPage = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const benefits = [
    ...
    'Drive qualified traffic with targeted ads',
    'Increased lead generation',
    'Enhanced conversion rates',
    'Maximized ROI for real estate business',
    'Precision-targeted advertising campaigns'
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1533750516457-a7f992034fec?w=1920&q=80')] bg-cover bg-center opacity-10"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          <p className="text-2xl text-gray-300 max-w-4xl animate-fade-in-delayed">
            PPC, Google Adwords, Display Ads - Boost brand visibility and drive qualified traffic with precision-targeted ads.
          </p>
        </div>
      </section>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div className="space-y-6">
              <div className="bg-white rounded-3xl p-10 shadow-xl border border-gray-100 card-3d">
                <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                  <MousePointerClick className="w-8 h-8 text-cyan-600" />
                  Our SEM Approach
                </h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-4">
                  Our SEM services focus on delivering immediate results through precision-targeted advertising campaigns. We manage PPC campaigns, Google Ads, and display advertising to maximize your ROI.
                </p>
                <p className="text-gray-600 text-lg leading-relaxed">
                  From keyword research to ad creation and optimization, we ensure your ads reach the right audience at the right time for maximum impact.
                </p>
              </div>
            </div>
            ...
            <div className="relative h-96 bg-gradient-to-br from-cyan-500 via-blue-500 to-purple-500 rounded-3xl overflow-hidden shadow-2xl card-3d">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Target className="w-32 h-32 text-white/30 tilt-animation" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-cyan-600 to-blue-600 rounded-3xl p-12 text-center shadow-2xl transform hover:scale-105 transition-all duration-500">
            ...
            <p className="text-white/90 text-xl mb-8 max-w-3xl mx-auto">
              Let's create powerful SEM campaigns that generate qualified leads and maximize your advertising ROI.
            </p>
            <Link to="/contact">
