...
import { ArrowLeft, Share2, Users, TrendingUp, CheckCircle2 } from 'lucide-react';
...
const SocialMediaMarketingPage = () => {
  ...
  const benefits = [
    ...
    'Generate quality leads through strategic SMM',
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          <p className="text-2xl text-gray-300 max-w-4xl animate-fade-in-delayed">
            Boost your brand visibility and engagement across leading social platforms. Increase website traffic and generate quality leads through strategic SMM.
          </p>
        </div>
      </section>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div className="space-y-6">
              <div className="bg-white rounded-3xl p-10 shadow-xl border border-gray-100 card-3d">
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-4">
                  We enhance your online presence and engagement through strategic social media marketing. Our comprehensive approach covers content creation, community management, paid advertising, and performance tracking.
                </p>
                <p className="text-gray-600 text-lg leading-relaxed">
                  From Facebook and Instagram to LinkedIn and Twitter, we manage your social presence across all major platforms to maximize reach and engagement.
                </p>
              </div>
            </div>
            ...
            <div className="relative h-96 bg-gradient-to-br from-cyan-500 via-blue-500 to-purple-500 rounded-3xl overflow-hidden shadow-2xl card-3d">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Share2 className="w-32 h-32 text-white/30 tilt-animation" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-cyan-600 to-blue-600 rounded-3xl p-12 text-center shadow-2xl transform hover:scale-105 transition-all duration-500">
            ...
            <p className="text-white/90 text-xl mb-8 max-w-3xl mx-auto">
              Let's create engaging social media campaigns that connect with your audience and drive results.
            </p>
            <Link to="/contact">
