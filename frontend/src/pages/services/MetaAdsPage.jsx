...
import { ArrowLeft, Instagram, Target, TrendingUp, CheckCircle2 } from 'lucide-react';
...
const MetaAdsPage = () => {
  ...
  const benefits = [
    ...
    'Drive measurable results and growth',
    'Facebook and Instagram ad expertise',
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1611162616305-c69b3037c0fc?w=1920&q=80')] bg-cover bg-center opacity-10"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          <p className="text-2xl text-gray-300 max-w-4xl animate-fade-in-delayed">
            Facebook Ads & Instagram Ads - Maximize your ROI with targeted campaigns that drive measurable results and growth.
          </p>
        </div>
      </section>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div className="space-y-6">
              <div className="bg-white rounded-3xl p-10 shadow-xl border border-gray-100 card-3d">
                <h2 className="text-3xl font-bold text-gray-900 mb-6 flex items-center gap-3">
                  ...
                  Driving Success with Meta Ads
                </h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-4">
                  Our Meta advertising expertise helps you reach your ideal customers on Facebook and Instagram. We create compelling ad campaigns that drive conversions and maximize your advertising spend.
                </p>
                <p className="text-gray-600 text-lg leading-relaxed">
                  From creative development to audience targeting and optimization, we manage every aspect of your Meta advertising to ensure maximum ROI.
                </p>
              </div>
            </div>
            ...
            <div className="relative h-96 bg-gradient-to-br from-cyan-500 via-blue-500 to-purple-500 rounded-3xl overflow-hidden shadow-2xl card-3d">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Instagram className="w-32 h-32 text-white/30 tilt-animation" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-cyan-600 to-blue-600 rounded-3xl p-12 text-center shadow-2xl transform hover:scale-105 transition-all duration-500">
            ...
            <p className="text-white/90 text-xl mb-8 max-w-3xl mx-auto">
              Let's create high-converting ad campaigns on Facebook and Instagram that drive real business growth.
            </p>
            <Link to="/contact">
