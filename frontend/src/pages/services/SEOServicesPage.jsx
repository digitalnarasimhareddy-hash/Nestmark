...
import { ArrowLeft, Search, TrendingUp, FileText, CheckCircle2 } from 'lucide-react';
...
const SEOServicesPage = () => {
  ...
  const benefits = [
    'Enhanced online visibility on search engines',
    'Attract organic traffic consistently',
    'Tailored SEO strategies for your industry',
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1562577309-4932fdd64cd1?w=1920&q=80')] bg-cover bg-center opacity-10"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          <p className="text-2xl text-gray-300 max-w-4xl animate-fade-in-delayed">
            Enhance your online visibility and attract organic traffic with our expert SEO strategies.
          </p>
        </div>
      </section>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            <div className="space-y-6">
              <div className="bg-white rounded-3xl p-10 shadow-xl border border-gray-100 card-3d">
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-4">
                  We create tailored SEO strategies that enhance your online visibility and drive organic traffic. Our comprehensive approach includes on-page optimization, technical SEO, content strategy, and link building.
                </p>
                <p className="text-gray-600 text-lg leading-relaxed">
                  From keyword research to implementation, we ensure your website ranks higher on search engines and reaches your target audience effectively.
                </p>
              </div>
            </div>
            ...
            <div className="relative h-96 bg-gradient-to-br from-cyan-500 via-blue-500 to-purple-500 rounded-3xl overflow-hidden shadow-2xl card-3d">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Search className="w-32 h-32 text-white/30 tilt-animation" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-cyan-600 to-blue-600 rounded-3xl p-12 text-center shadow-2xl transform hover:scale-105 transition-all duration-500">
            ...
            <p className="text-white/90 text-xl mb-8 max-w-3xl mx-auto">
              Let's optimize your website for search engines and drive organic traffic to your business.
            </p>
            <Link to="/contact">
