...
import { ArrowLeft, TrendingUp, Target, BarChart3, Zap, CheckCircle2 } from 'lucide-react';
...
const PerformanceMarketingPage = () => {
  ...
  const benefits = [
    'Data-driven campaigns that deliver Quality Leads',
    'Measurable ROI on every investment',
    'Precision-driven strategies for maximum conversions',
    'Enhanced brand visibility across channels',
      ...
      <section className="relative pt-32 pb-20 overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          <p className="text-2xl text-gray-300 max-w-4xl animate-fade-in-delayed">
            Achieve unparalleled success with precision-driven strategies that boost conversions, enhance brand visibility, and deliver a tangible return on every investment.
          </p>
        </div>
      </section>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-3xl p-10 shadow-xl border border-gray-100 card-3d">
                ...
                <p className="text-gray-600 text-lg leading-relaxed mb-4">
                  We design data-driven campaigns that deliver Quality Leads and maximize ROI. Our performance marketing approach focuses on measurable results, ensuring every rupee spent contributes to your business growth.
                </p>
                <p className="text-gray-600 text-lg leading-relaxed">
                  From strategy to design, consulting, and execution, we provide comprehensive solutions tailored to your needs locally in Bengaluru and globally.
                </p>
              </div>
            </div>
            ...
            <div className="relative h-96 bg-gradient-to-br from-cyan-500 via-blue-500 to-purple-500 rounded-3xl overflow-hidden shadow-2xl card-3d">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <TrendingUp className="w-32 h-32 text-white/30 tilt-animation" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-cyan-600 to-blue-600 rounded-3xl p-12 text-center shadow-2xl transform hover:scale-105 transition-all duration-500">
            ...
            <p className="text-white/90 text-xl mb-8 max-w-3xl mx-auto">
              Let's work together to create data-driven campaigns that deliver real results for your business.
            </p>
            <Link to="/contact">
